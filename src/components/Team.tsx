  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[var(--site-max-width)]">
        ...
        {/* Photo section with layered headings */}
        <div ref={photoRef} className="relative mb-12 overflow-hidden" style={{ minHeight: "120vh" }}>
          ...
          <motion.div
            style={{ y: imageY }}
            className="relative z-20 mx-auto aspect-[9/16] w-full max-w-[280px] overflow-hidden sm:max-w-[320px] md:max-w-[420px] lg:max-w-[500px] xl:max-w-[580px]"
          >
            <Image
          ...
          {/* Outline/stroke heading — IN FRONT of the photo */}
          <h2
        ...
        {/* Description — z-40 so it's always above the parallax image */}
        <div className="relative z-40 mb-12 flex justify-end">
          <ScrollOpacity start={0} end={0.35} direction="out-in" className="max-w-xl">
            <div>
              <p className="mb-4 font-sans font-light leading-relaxed text-[var(--accent-2)]" style={{ fontSize: "clamp(16px, 1.2vw, 26px)" }}>
              ...
              <p className="font-sans font-light leading-relaxed text-[var(--accent-2)]" style={{ fontSize: "clamp(16px, 1.2vw, 26px)" }}>
        ...
        <div className="relative z-40 mt-4 flex justify-end gap-6">
          <motion.div
